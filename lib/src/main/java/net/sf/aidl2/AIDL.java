...
public @interface AIDL {
     ...
     * <p>
     *
     * If empty, defaults to fully qualified name of interface class.
     */
     ...
     *
     * <ol>
     * <li> The server does not expose itself to untrusted clients (e.g. the {@link Service} is
     * not exported or protected from other applications by signature-level permission).
     * <li> Clients never leak received {@link Binder} to untrusted processes.
     * </ol>
     *
