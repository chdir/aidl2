...
/**
 * Indicates, that annotated AIDL2 abstrMethod parameter (or return type) may be represented by
 ...
 * {@link Context#createPackageContext} abstrMethod with {@link Context#CONTEXT_INCLUDE_CODE} and
