...
import net.sf.fakenames.aidl2.internal.util.SuperficialValidation;
...
public final class AidlValidator extends AptHelper {
    ...
    Element validate(TypeElement element) throws AnnotationException, AnnotationValueException {
        ...
        final AnnotationMirror aidlAnnotation = Util.getAnnotation(element, net.sf.fakenames.aidl2.AIDL.class);
