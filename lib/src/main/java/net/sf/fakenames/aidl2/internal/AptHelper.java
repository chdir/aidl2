...
import net.sf.fakenames.aidl2.AidlUtil;
import net.sf.fakenames.aidl2.internal.codegen.MethodInstantiation;
import net.sf.fakenames.aidl2.internal.util.JavaVersion;
...
import static net.sf.fakenames.aidl2.internal.util.JavaVersion.JAVA_1_7;
import static net.sf.fakenames.aidl2.internal.util.Util.isTypeOf;
...
public abstract class AptHelper implements ProcessingEnvironment {
    ...
    public CodeBlock emitDefaultConstructorCall(TypeMirror capturedType) {
        ...
        if (JavaVersion.atLeast(JAVA_1_7)) {
