...
final class Config {
    static final String OPT_LOGFILE = "aidl2_log_to_file";
    static final String OPT_PRINT_TRACE = "aidl2_verbose";
    static final String OPT_LIBRARY = "aidl2_library";
    static final String OPT_SUPPRESS_ALL = "aidl2_dontwarn";
    static final String OPT_PKG_NAME = "aidl2_dontwarn";
    static final String OPT_DISABLE_EASTER_EGGS = "aidl2_no_jokes";
