...
final class StubGenerator extends AptHelper implements AidlGenerator {
    ...
    private void writeModel(AidlModel model, Filer filer) throws IOException, ElementException {
        ...
        if (!model.methods.isEmpty()) {
            final net.sf.fakenames.aidl2.internal.State aidlReader = new net.sf.fakenames.aidl2.internal.State(getBaseEnvironment(), baseAllocator)
            ...
            for (net.sf.fakenames.aidl2.internal.AidlMethodModel method : model.methods) {
            ...
            for (int i = 0; i < model.methods.size(); i++) {
                final net.sf.fakenames.aidl2.internal.AidlMethodModel method = model.methods.get(i);
                ...
                final net.sf.fakenames.aidl2.internal.State methodReader = aidlReader.clone();
                ...
                final List<net.sf.fakenames.aidl2.internal.codegen.TypedExpression> methodArgs = new ArrayList<>();

                for (AidlParamModel param : method.parameters) {
                    final net.sf.fakenames.aidl2.internal.State paramMarshaller = methodReader.clone()
                            .setParameter(param);
                    ...
                    if (param.inParameter) {
                        ...
                        } catch (net.sf.fakenames.aidl2.internal.exceptions.CodegenException cde) {
                        ...
                        if (param.isReturn()) {
                            if (isVoid(param.type)) {
                                ...
                                try {
                                    ...
                                    final CodeBlock callCode = literal("this.delegate.$L($L)", methodName, argList(method.parameters, methodArgs));
    ...
    private CodeBlock argList(AidlParamModel[] parameters, List<net.sf.fakenames.aidl2.internal.codegen.TypedExpression> params) {
        if (params.isEmpty()) {
        ...
        for (int i = 0; i < params.size(); i++) {
            final net.sf.fakenames.aidl2.internal.codegen.TypedExpression param = params.get(i);
    ...
    private net.sf.fakenames.aidl2.internal.codegen.TypedExpression readInParameter(CodeBlock.Builder code, net.sf.fakenames.aidl2.internal.State reader, String name) throws net.sf.fakenames.aidl2.internal.exceptions.CodegenException {
        final CodeBlock.Builder initializationCode = CodeBlock.builder();

        final net.sf.fakenames.aidl2.internal.codegen.TypedExpression assignmentCode = reader.buildReader(name)
        ...
        if (initializationBlock.isEmpty()) {
            ...
            return new net.sf.fakenames.aidl2.internal.codegen.TypedExpression(literal(reader.name.toString()), resultType);
        } else {
    ...
    private TypeMirror writeOutParameter(CodeBlock.Builder code, net.sf.fakenames.aidl2.internal.State writer, String name) throws net.sf.fakenames.aidl2.internal.exceptions.CodegenException {
