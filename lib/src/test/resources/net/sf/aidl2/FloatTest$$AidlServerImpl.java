...
public final class FloatTest$$AidlServerImpl extends Binder {
  ...
  static final int TRANSACT_methodWithFloatParameter = IBinder.FIRST_CALL_TRANSACTION;
  ...
  protected boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
    switch(code) {
      case TRANSACT_methodWithFloatParameter: {
        data.enforceInterface(this.getInterfaceDescriptor());

        final float parameter = data.readFloat();

        delegate.methodWithFloatParameter(parameter);
