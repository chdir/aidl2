...
public final class IntTest$$AidlClientImpl implements IntTest {
  ...
  public IntTest$$AidlClientImpl(IBinder delegate) throws RemoteException {
  ...
  public void methodWithIntParameter(int parameter) throws RemoteException {
    ...
    try {
      ...
      delegate.transact(IntTest$$AidlServerImpl.TRANSACT_methodWithIntParameter, data, reply, 0);
      reply.readException();
    } finally {
      data.recycle();
      reply.recycle();
